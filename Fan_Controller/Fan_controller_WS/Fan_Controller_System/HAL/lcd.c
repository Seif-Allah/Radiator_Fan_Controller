...
#include "lcd.h" /*include the header file of module*/
#include "..\MCAL\gpio.h" /*include gpio module from MCAL Layer*/
 ...
 *
 * Arguments :
 * a_command (the binary of command want to send to LCD)
 */
 ...
 * Arguments :
 * a_data (the binary of data want to show on LCD)
 */
 ...
 * Arguments :
 * a_Str (the binary of String want to show on LCD)
 */
 ...
 * Arguments :
 * a_col (number of column want to move cursor to)
 * a_row (number of row want to move cursor to)
 * by this indexes can move cursor wherever we want to write any where on LCD
 */
 ...
 * a_col (number of column want to move cursor to)
 * a_row (number of row want to move cursor to)
 * a_Str (the string want to display)
 * by this indexes display string wherever we want to write any where on LCD
 */
 ...
 * Arguments :
 * a_data (the decimal number want to display on LCD)
 *
 */
